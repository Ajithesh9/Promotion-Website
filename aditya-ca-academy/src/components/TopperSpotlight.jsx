    ...
    return (
        <section className="relative max-w-5xl mx-auto px-6 mb-16 z-10 mt-8">
            ...
            <motion.div
                ...
                className="bg-surface border border-border rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row relative max-h-[600px]"
            >
                ...
                <div className="relative overflow-hidden min-h-[300px] md:w-5/12 md:min-h-full">
                    ...
                    {/* Gradient Overlay */}
                    {/* Updated: from-surface, to-surface */}
                    <div className="absolute inset-0 bg-gradient-to-t from-surface via-transparent to-transparent md:bg-gradient-to-r md:from-transparent md:to-surface z-10 pointer-events-none"></div>
                </div>
                ...
                <div className="p-8 flex flex-col justify-center relative z-20 md:w-7/12 md:pl-24">
                    ...
                    {/* Footer Section */}
                    {/* Updated: border-border, bg-primary/10, text-primary */}
